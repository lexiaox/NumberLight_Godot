...
func _process(_delta: float) -> void:
	...
	var player_foot: Vector2 = get_player_foot_position()
	...
	var well_available: bool = can_interact_with_well(player_foot)
...
func should_focus_chest(player_position: Vector2, well_available: bool) -> bool:
	...
	var well_distance: float = player_position.distance_to(_well_interact_point.global_position)
